...
public class Color {
    ...
    public Color(int colorInt) {
        this.red = ColorHelper.red(colorInt) / (float) 0xFF;
        this.green = ColorHelper.green(colorInt) / (float) 0xFF;
        this.blue = ColorHelper.blue(colorInt) / (float) 0xFF;
        this.alpha = ColorHelper.alpha(colorInt) / (float) 0xFF;
    }
    ...
    public int toColorInt() {
        ...
        return ColorHelper.argb(a8, r8, g8, b8);
    }
