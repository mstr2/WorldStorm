 ...
 * <p/>
 * ImageSource supports four source types: <ul> <li>Android {@link Bitmap}</li> <li>WorldWind {@link
...
public class ImageSource {
     ...
     * @return the new image source
     */
    public static ImageSource fromResource(String id) {
        ImageSource imageSource = new ImageSource();
     ...
     * bitmap; bitmap factory; file path; URL string.
     *
    ...
    public String asResource() {
        return (this.type == TYPE_RESOURCE) ? (String) this.source : null;
    }
    ...
    protected static class LineStippleBitmapFactory implements BitmapFactory {
        ...
        public Bitmap createBitmap() {
            final int transparent = ColorHelper.argb(0, 0, 0, 0);
            final int white = ColorHelper.argb(255, 255, 255, 255);
            ...
            if (factor <= 0) {
                ...
                Bitmap bitmap = Bitmap.createBitmap(width, 1 /*height*/, Bitmap.Format.ARGB_4444);
