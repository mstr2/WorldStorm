...
public class RenderResourceCache extends LruMemoryCache<Object, RenderResource>
    ...
    public static int recommendedCapacity(SystemInfo systemInfo) {
        if (systemInfo != null) {
            if (systemInfo.getTotalMemory() >= 1024 * 1024 * 2048L) { // use 384 MB on machines with 2048 MB or more
                return 1024 * 1024 * 384;
            } else if (systemInfo.getTotalMemory() >= 1024 * 1024 * 1536) { // use 256 MB on machines with 1536 MB or more
                return 1024 * 1024 * 256;
            } else if (systemInfo.getTotalMemory() >= 1024 * 1024 * 1024) { // use 192 MB on machines with 1024 MB or more
                return 1024 * 1024 * 192;
            } else if (systemInfo.getTotalMemory() >= 1024 * 1024 * 512) { // use 96 MB on machines with 512 MB or more
                return 1024 * 1024 * 96;
