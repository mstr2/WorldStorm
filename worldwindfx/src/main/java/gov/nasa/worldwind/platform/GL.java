...
public interface GL {
    ...
    //
    @Deprecated int GL_STENCIL_INDEX = 0x1901;
    ...
    String glGetActiveAttrib(
            int program, int index, java.nio.IntBuffer size, java.nio.IntBuffer type);
    ...
    void glGetAttachedShaders(
            int program, int maxcount, java.nio.IntBuffer count, java.nio.IntBuffer shaders);
    ...
    void glReadPixels(
            int x, int y, int width, int height, int format, int type, java.nio.Buffer pixels);
    ...
    void glShaderBinary(
            int n, int[] shaders, int offset, int binaryformat, java.nio.Buffer binary, int length);
