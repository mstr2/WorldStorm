...
import gov.nasa.worldwind.input.InputEvent;
...
public class NavigatorEventSupport {
    ...
    protected Handler stopHandler = new Handler(new Handler.Callback() {
        @Override
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        this.lastTouchEvent = new MotionEvent(event);
    }
    ...
    protected void notifyListeners(int action, InputEvent inputEvent) {
        NavigatorEvent event = NavigatorEvent.obtain(this.wwd.getNavigator(), action, inputEvent);
